      ...
      p = function (t, e, r, n, o) {
        if (void 0 !== e) {
          ...
          if (Array.isArray(n)) {
            ...
            if (!p)
              throw new Error(
                'Filterizr: invalid value "' + e + '" for option "' + t + '" received.' + c(o)
              );
          }
        }
      },
  ...
  function (t, e, r) {
    ...
    var n = r(2),
      ...
      l = (function () {
        function t() {
          var e =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '.filtr-container',
            r = arguments[1];
          i(this, t),
            (this.$node = a(e)),
            this.$node.css({
            ...
            (this.props = { FilterItems: this.getFilterItems(r), w: this.getWidth(), h: 0 }),
          ...
          s(t, [
            {
              key: 'destroy',
              value: function () {
                this.$node.attr('style', '').find('.filtr-item').attr('style', ''),
                  this.unbindEvents();
              }
            },
            {
          ...
          o(t, [
            {
              ...
              value: function (t, e) {
                var r = Object(n.h)(e);
                (r.transform += ' translate3d(' + t.left + 'px,' + t.top + 'px, 0)'),
                  this.$node.css(r),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (e.transform += ' translate3d(' + r.left + 'px,' + r.top + 'px, 0)'),
                  this.$node.css(e),
        ...
        return (
          u(t, [
            ...
            },
            {
              ...
              value: function (t) {
                Object(l.c)('animationDuration', t.animationDuration, 'number'),
                  ...
                  Object(l.c)('delayMode', t.delayMode, 'string', ['progressive', 'alternate']),
                  ...
                  (t.callbacks || t.animationDuration) && this.rebindFilterContainerEvents(),
                  t.filter && this.filter(t.filter),
                  t.multifilterLogicalOperator && this.filter(this.options.filter);
              }
            },
            {
              key: 'toggleFilter',
            ...
            },
            {
              ...
              value: function (t) {
                for (var e = Object(l.j)(t); t.length > 1 && Object(l.f)(t, e); )
                  e = Object(l.j)(t);
                return e;
              }
            },
