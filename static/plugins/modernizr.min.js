window.Modernizr = (function (e, t, n) {
            ...
            r &&
              ...
              /^range$/.test(o) && E.style.WebkitAppearance !== n
                ? (g.appendChild(E),
                  ...
                  (r =
                    a.getComputedStyle &&
                    'textfield' !== a.getComputedStyle(E, null).WebkitAppearance &&
                    0 !== E.offsetHeight),
                  g.removeChild(E))
                : /^(search|tel)$/.test(o) ||
                  (r = /^(url|email)$/.test(o)
    ...
    z = function (t) {
      ...
      return (
        F('@media ' + t + ' { #' + v + ' { position: absolute; } }', function (t) {
          r =
            'absolute' ==
            (e.getComputedStyle ? getComputedStyle(t, null) : t.currentStyle).position;
        }),
        r
      );
    },
  ...
  (f =
    ...
    (M.cssgradients = function () {
      ...
      return (
        r((e + '-webkit- '.split(' ').join(t + e) + S.join(n + e)).slice(0, -e.length)),
    ...
    (M.svgclippaths = function () {
      return (
        !!t.createElementNS && /SVGClipPath/.test(w.call(t.createElementNS(N.svg, 'clipPath')))
      );
    });
  for (var H in M)
  ...
  return (
    ...
    (g.className =
      g.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (h ? ' js ' + $.join(' ') : '')),
    p
  );
})(this, this.document);
