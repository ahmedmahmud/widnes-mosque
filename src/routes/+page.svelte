...
<!-- <div id="loader"> </div> -->
<nav id="nav" class="navbar navbar-expand-lg navbar-dark navigation fixed-top">
  <div id="nav-border" class="nav-border" />
  <div class="container-fluid nav-container">
    <a class="navbar-brand" href="#">
      <img src="images/logo-white.png" class="img-fluid" alt="" height="60" />
    </a>
    <button
...
<header
  class="hero-area th-fullpage"
  data-parallax="scroll"
  data-image-src="images/hero3-min.jpg"
  data-bleed="100"
  data-ios-fix="false"
...
>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1 class="hero-text">Worship, Charity & Community Welfare in Widnes</h1>
      </div>
    </div>
  </div>
</header>

<div id="times" style="position: relative; top: -86px;" />
<!-- <section class="time-section" data-parallax="scroll" data-image-src="images/fabrictiled.jpg" data-z-index="-99"  data-ios-fix="false" data-android-fix="false"> -->
...
<div id="directions" style="position: relative; top: -86px;" />
<section class="directions">
  <div class="section">
    ...
    <div class="directions-content">
      <div class="container">
        <p><b>ADDRESS:</b> 31-35 Alforde St, Widnes. WA8 7TR</p>
...
>
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <button type="button" class="btn-close ttt" data-bs-dismiss="modal" aria-label="Close" />
      <div class="modal-body">
        <h4 class="modal-title" id="exampleModalLabel">Widnes Mosque Jumaa</h4>
        <hr />
        <p>
          Please come join us on: <br />
          Friday 8th April, Jumaa begins 1:30pm <br />
        </p>
        <p>
          Please arrive early to view our facilities <br />
          ...
          Do not park at the rear of the mosque <br />
        </p>
      </div>
    </div>
  </div>
...
<div id="donate" style="position: relative; top: -86px;" />
<section
  class="donate"
  data-parallax="scroll"
  data-image-src="images/donatebanner.jpg"
  data-bleed="200"
  data-ios-fix="false"
  data-android-fix="false"
>
  <div class="section">
    ...
    <div class="donate-content">
      <div class="container text-center">
        <p>You can donate to our Masjid here</p>
        <div class="details">
          <p><b>Account Name:</b> Widnes Deen Center</p>
          <p><b>Sort Code:</b> 16-24-06</p>
          <p><b>Account Number:</b> 20374041</p>
        </div>
        <!-- <button class="btn btn-default btn-main">Donate</button> -->
      </div>
    </div>
  </div>
  <!-- <div class="section" >
...
<div id="about" style="position: relative; top: -86px;" />
<section class="about">
  <div class="section">
    <div class="text-center">
    ...
    <div class="about-content">
      <div class="container text-center">
        <p>
          Widnes Deen Center is the body that helps the Widnes Islamic Centre to function. The
          Associations role is to provide all manner of Islamic functions, events and general
          day-to-day running of the centre.
        </p>
        <!-- <button class="btn btn-default btn-main">Read More</button> -->
      </div>
    </div>
  </div>
</section>
      ...
      <!-- <div class="col-md-4">
          <div class="footer-social-media">
            ...
            <p class="contact-address">
              Phone: <a href="tel:+610383666274">-</a><br>
              Email: <a href="mailto:info@info.com">-</a>
            </p>
          </div>
        </div>
        <div class="col-md-4">
